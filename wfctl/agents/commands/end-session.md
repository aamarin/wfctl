...
allowed-tools: Read Write Bash(date*) Bash(git status*) Bash(git log*) Bash(git diff*) Bash(git symbolic-ref*) Bash(git rev-parse*) Bash(wfctl end*) Bash(wfctl status*) Bash(wfctl state-dir*) Bash(wfctl issue view*) Bash(wfctl issue close*) Bash(wfctl issue comment*) Bash(wfctl issue label*) Bash(wfctl report-action*) Bash(wfctl report-block*) Bash(wfctl feature-paths*)
---
