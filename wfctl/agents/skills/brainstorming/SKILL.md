---
name: brainstorming
description: "Required before any creative work - creating features, building components, adding functionality, or modifying behavior. Explores user intent, requirements and design before implementation."
---
...
- Carry the validated design forward to `idea-refine` in context — it owns the
  single write to `specs/<branch>/design.md`
- Use elements-of-style:writing-clearly-and-concisely skill if available

**Spec Self-Review:**
Before handing off, look at the design with fresh eyes:
...
**User Review Gate:**
After the self-review loop passes, ask the user to review the design before it is written:
