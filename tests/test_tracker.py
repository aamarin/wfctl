...
def test_free_text_lands_as_single_inert_argv_token(agent_dir: Path, captured_argv: list) -> None:
    ...
    # `subprocess` module rather than one module's reference to it, so any git
    # call made on the way to the write lands here too. What this test is about
    # is the shape of the token, and that is the last call.
